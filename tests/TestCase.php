...
abstract class TestCase extends BaseTestCase
{
     ...
     * @return $this
     */
    protected function assertNotSoftDeletedInDatabase($table, array $data, $connection = null)
    {
     ...
     * @return $this
     */
    protected function assertSoftDeletedInDatabase($table, array $data, $connection = null)
    {
        $database = $this->app->make('db');
